...
1. **Download the plugin**: Download the latest version of the `GameMenu` plugin from [here](https://hangar.papermc.io/ItzLoghotXD/GameMenu) or [here](https://modrinth.com/plugin/game-menu) or [here](https://www.spigotmc.org/resources/gamemenu.122426) or maybe from [here](https://github.com/ItzLoghotXD/GameMenu/releases).
